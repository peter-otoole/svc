var connection, mySessionID, groupSessionID, messagesDialogOpen = true;
	                ...
	                setTimeout (
	                        function( ) {
			                                        ...
			                                        connection
			                                                .on (
			                                                        ...
			                                                        function( data ) {
				                                                        ...
				                                                        if ( data === "ok" ) {
					                                                        connection.emit ( "get-full-drawing", {
						                                                        groupSession: groupSessionID
					                                                        } );
					                                                        connection
					                                                                .on (
					                                                                        ...
					                                                                        function( data ) {
						                                                                        ...
						                                                                        currentDrawing
						                                                                                .setDrawingSequence ( data.data.drawingInstructions.drawingSequence );
			                        ...
			                        if ( data.drawingInstruction.shape === "groupmessage" ) {
				                        ...
				                        $ ( "#messages-content-view" ).append (
				                                "<div class=\"messages-message-text\">"
				                                        + data.drawingInstruction.sender + ": "
				                                        + data.drawingInstruction.text + "</div>" );
				                        if ( !scrollRecent ) {
					                        scrollRecent = true;
					                        $ ( "#messages-main-view" ).animate ( {
						                        scrollTop: $ ( "#messages-content-view" ).height ( )
		                        ...
		                        connection
		                                .on (
		                                        ...
		                                        function( data ) {
			                                        ...
			                                        var id = data.drawingInstruction.elemID, type = data.drawingInstruction.type, value = data.drawingInstruction.value;
			                                        if ( type === "visible" ) {
		                        ...
		                        connection.on ( "request-full-drawing", function( data ) {
			                        ...
			                        connection.emit ( "get-full-drawing", {
				                        drawingInstructions: currentDrawing
			                        } );
		                        } );
	                        }, 100 );
                } );
